...
#path: /Users/meylis/Desktop/Gaidar/DATA for НИР/FINAL/data_final_reer.xlsx
...
# Load the Excel file
data_final_reer <- read_excel("/Users/meylis/Desktop/Gaidar/DATA for НИР/FINAL/data_final_reer.xlsx", sheet = "REER")
