...
#path: /Users/meylis/Desktop/Gaidar/DATA for НИР/FINAL/data_final_gdp.xlsx
...
# Load the Excel file
data_final_gdp <- read_excel("/Users/meylis/Desktop/Gaidar/DATA for НИР/FINAL/data_final_gdp.xlsx", sheet = "Real GDP (levels, IMF)")
