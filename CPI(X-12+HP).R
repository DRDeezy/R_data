...
# Load the Excel file
data_final <- read_excel("/Users/meylis/Desktop/Gaidar/DATA for НИР/FINAL/data_final.xlsx", sheet = "Inflation (CPI, q-o-q)")
...
cpi_data <- data_final[, start_col:end_col]
...
rownames(final_INFL_df) <- as.list(data_final$Country)
